...
<!--               	<img src="getVerify.php" alt="" /> -->
              	<a href="javascript:;" onclick="document.getElementById('verify').src='getVerify.php?r='+Math.random()">
        <img id="verify" border='1' src='getVerify.php?r=echo rand(); ?>' style="width:100px; height:30px" />
    看不清，换一张
    </a>
